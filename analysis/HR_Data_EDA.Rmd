...
```{css, echo=FALSE}
/* ===== FIX RIGHT EDGE CLIPPING (SHOW BUTTONS / ARROWS) ===== */
.main-container {
  width: calc(100vw - 300px) !important;
  max-width: 1200px !important;   /* <-- THIS FIXES EVERYTHING */
  margin-left: 270px !important;
  margin-right: auto !important;
  padding-right: 20px !important;
}

/* ===== PREVENT CONTENT OVERFLOW CUT-OFF ===== */
pre, .sourceCode {
  overflow-x: auto !important;
}

/* ===== FIX SHOW/HIDE BUTTON VISIBILITY ===== */
.showhide {
...
/* ===== LIMIT MASSIVE OUTPUT HEIGHT (DATA PREVIEW BLOCKS) ===== */
pre code {
  max-height: 400px;
  overflow-y: auto;
  display: block;
...
.main-container {
  ...
  width: 100% !important;
  margin: 0 !important;
  padding-left: 280px !important;  /* space for TOC */
  padding-right: 20px !important;
}
...
/* ===== REMOVE ALL GRID / COLUMN BEHAVIOR ===== */
.row {
  margin: 0 !important;
}
...
/* ===== TIBBLE (KNITR TABLE) SCALING ===== */
table {
  display: table !important;
  width: auto !important;
  max-width: 100% !important;
  font-size: 16px !important;   /* increase readability */
}
...
ggsave(fig_path, p, width = 10, height = 5.2, dpi = 300, bg = "white")
...
ggsave(fig_path, p, width = 10, height = 5.3, dpi = 300, bg = "white")
...
ggsave(fig_path, p, width = 10, height = 5.5, dpi = 300, bg = "white")
