...
project_overview <- tibble(
  ...
  Description = c(
    ...
    "R, tidyverse, ggplot2, caret, fastDummies",
...
```{r 03-num-hist-density, echo=TRUE}
# Create output directory for continuous variable plots
plot_dir <- create_plot_dir("continuous")

# Convert continuous variables to long format
numeric_long <- hr_df %>%
...
# Generate histogram + density plots for each variable
...
```{r 03-likert-distributions, echo=TRUE}
# Create output directory for Likert variable plots
...
# Create output directory for numeric outlier plots
...
numeric_plot_files <- purrr::map_chr(names(numeric_vars), function(var) {
...
# Create output directory for ordered scale plots
...
# Generate plots for ordered variables
...
cat_plot_files <- purrr::map_chr(cat_vars, function(var){
...
```{r 03-correlation-matrix, fig.width=12, fig.height=12, echo=TRUE}
...
ggsave(
  filename = file.path(fig_dir, "correlation_matrix.png"),
  plot = p,
  width = 14,
  height = 14,
  dpi = 300,
...
```{r 03-strong-correlation-matrix, fig.width=10, fig.height=8, echo=TRUE}
# Create output directory for report figures
fig_dir <- "outputs/figures"
...
# Save high-resolution version for documentation
ggsave(
  filename = file.path(fig_dir, "strongest_correlations.png"),
  plot = p,
  width = 12,
  height = 9,
  dpi = 300,
...
# Create output directory for target variable plots
plot_dir <- create_plot_dir("targets")
...
target_plot_files <- purrr::map_chr(target_names, function(var){

  filepath <- file.path(
    plot_dir,
    paste0("target_", var, ".png")
  )
...
```{r improved-vif-numeric-plot, fig.width=11, fig.height=8, echo=TRUE}
# Create output directory for report figures
fig_dir <- "outputs/figures"
...
# Save high-resolution version for documentation
ggsave(
  filename = file.path(fig_dir, "vif_numeric_predictors.png"),
  plot = p,
  width = 12,
  height = 9,
  dpi = 300,
...
```{r improved-vif-categorical-plot, fig.width=11, fig.height=8, echo=TRUE}
...
# Save high-resolution version for documentation
ggsave(
  filename = file.path(fig_dir, "vif_categorical_predictors.png"),
  plot = p,
  width = 12,
  height = 9,
  dpi = 300,
...
```{r categorical_vif_plot, fig.width=9, fig.height=6, fig.align="center", echo=TRUE}
# Create output directory for report figures
fig_dir <- "outputs/figures"
...
ggsave(
  filename = file.path(fig_dir, "vif_categorical_updated.png"),
  plot = p,
  width = 11,
  height = 8,
  dpi = 300,
...
```{r 03-skewness-of-num-vars, fig.width=9, fig.height=6, fig.align="center", echo=TRUE}
# Create output directory for report figures
fig_dir <- "outputs/figures"
...
ggsave(
  filename = file.path(fig_dir, "numeric_variable_skewness.png"),
  plot = p,
  width = 11,
  height = 8,
  dpi = 300,
...
```{r 03-skew-num-graph, fig.width=9, fig.height=6, echo=TRUE}
# Create output directory for report figures
fig_dir <- "outputs/figures"
...
# Save high-resolution figure
ggsave(
  filename = file.path(fig_dir, "most_skewed_numeric_variables.png"),
  plot = p,
  width = 11,
  height = 8,
  dpi = 300,
...
### Modeling Implications of Distribution Imbalance
...
```{r 03-categorical-distributions, results='asis', echo=TRUE}
# Create output directory for categorical plots
plot_dir <- create_plot_dir("categorical")
...
```{r 03-skew-cat-graph, fig.width=9, fig.height=6, echo=TRUE}
...
# Save high-resolution figure
ggsave(
  filename = file.path(fig_dir, "categorical_variable_imbalance.png"),
  plot = p,
  width = 11,
  height = 8,
  dpi = 300,
