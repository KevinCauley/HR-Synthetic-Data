...
/* REMOVE MASSIVE SPACE FROM WIDGETS */
.html-widget {
  margin: 0 !important;
  padding: 0 !important;
...
create_plot_dir <- function(folder){
  path <- file.path(OUTPUT_ROOT, "plots", folder)
...
coef_df <- coef_df %>%
  mutate(term_clean = clean_label(term))
...
ggsave(filename = file.path(FIG_DIR, "logistic_preview.png"),
