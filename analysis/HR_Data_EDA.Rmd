...
/* Remove hidden spacing wrappers */
.section {
  margin-left: 0 !important;
  padding-left: 0 !important;
}

/* Remove extra white space below plots */
.figure {
...
slickR(cat_plot_files, slideType = "img", width = "900px") +
  settings(dots = TRUE, arrows = TRUE, infinite = FALSE, adaptiveHeight = TRUE)
```
